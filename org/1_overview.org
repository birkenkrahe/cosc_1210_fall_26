...
- First *quiz* based on all materials from this week (due Fri 2pm)

- Simple *home assignment* with Jupyter notebooks (due Fri 2 pm)

- Upload code-along notebook (due Fri 2 pm) for participation
